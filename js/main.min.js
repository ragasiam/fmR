function radioTitle(){$.ajax({type:"GET",url:"http://109.74.196.48:8251/stream.xspf",async:!0,cache:!1,dataType:"xml",success:function(c){(c=$(c).find("track").find("title").text())?($(".live_tag").toggle(!1),$("#current_track_title").text(c)):fetchCustomTitle()},error:function(c){console.log(c.message)}})}function fetchCustomTitle(){$(".live_tag").toggle(!0);$("#current_track_title").text("Live Streaming")}
